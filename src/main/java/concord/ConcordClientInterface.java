...
public interface ConcordClientInterface extends Remote
{
	...
	public void accept(int serverId) throws RemoteException;
	...
	public void changeRole(int userId, RoleComponent r, int serverId) throws InvalidActionException, RemoteException;
